'''
Based on https://github.com/Mikerov/pytorch-functional-warmup.
'''
...
class LinearWarmupScheduler(FuncLRScheduler):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs, fns=[self.linear])
...
class QuadraticWarmupScheduler(FuncLRScheduler):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs, fns=[self.quadratic])
...
class QuadraticSqWarmupScheduler(FuncLRScheduler):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs, fns=[self.quadratic_sq])

    @staticmethod
    def quadratic_sq(last_epoch, lr_goal, warm_epochs):
        if last_epoch > warm_epochs:
            return -1
