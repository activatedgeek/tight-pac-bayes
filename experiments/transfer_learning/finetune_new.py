...
def Trial(cfg,i=None):
    with warnings.catch_warnings():
        ...
        try:
            ...
            trainer.dataloaders['test'],lr=3e-3,epochs=40,use_kmeans=False,levels=7,misc_extra_bits=4+2))
...
if __name__=='__main__':
    with warnings.catch_warnings():
        ...
        cfg_spec2.update({
            ...
            'd':[500,1000,2000,3000,4000,6000],'num_epochs':60,'lr':.03,
            'modelname':'efficientnet_b0','pretrained':True,
        })
        cfg_spec2 = argupdated_config(cfg_spec2)
        
        name = f"finetune_{cfg_spec['dataset']}_effnetb0"
